---
title: Welcome to Rusteze
description: Get started building your docs site with Starlight.
template: splash # Remove or comment out this line to display the site sidebar on this page.
hero:
  tagline: Write once, deploy anywhere without writing any infrastructure files
  image:
    file: ../../assets/rusteze.png
  actions:
    - text: Get started
      link: /get-started/
      icon: right-arrow
    - text: View on GitHub
      link: https://github.com/rustezeorg/rusteze
      icon: external
      variant: minimal
---
